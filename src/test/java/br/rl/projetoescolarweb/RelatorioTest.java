...
import br.rl.projetoescolarweb.servico.Relatorio;
...
public class RelatorioTest {
	...
	public void deveFuncionarParaAsNotasNaOrdemAleatoria() {
		...
		this.notas.add(new Nota(1L, alunos.get(0), disciplina, 2.5));
		this.notas.add(new Nota(2L, alunos.get(1),disciplina, 9.5));
		this.notas.add(new Nota(3L, alunos.get(2),disciplina, 7.5));
	...
	public void deveFuncionarParaAsNotasNaOrdemDecrescente() {
		...
		this.notas.add(new Nota(1L, alunos.get(0),disciplina, 9.5));
		this.notas.add(new Nota(2L, alunos.get(1),disciplina, 7.5));
		this.notas.add(new Nota(3L, alunos.get(2),disciplina, 2.5));
	...
	public void deveFuncionarComUmaUnicaNota() {
		...
		notas.add(new Nota(1L, alunos.get(0), disciplina, 2.5));
	...
	public void deveFuncionarAIdentificacaoDas3MaioresNotasDosAlunos() {
		...
		this.notas.add(new Nota(1L, alunos.get(0),disciplina, 9.0));
		this.notas.add(new Nota(2L, alunos.get(1), disciplina, 10.0));
		this.notas.add(new Nota(3L, alunos.get(2),disciplina, 8.0));
		this.notas.add(new Nota(4L, alunos.get(3),disciplina, 2.5));
	...
	public void deveFuncionarParaIdentificarAs3MaioresNotasDeUmUnicoAluno() {
		...
		notas.add(new Nota(1L, alunos.get(0), disciplina, 10.0));
	...
	public void deveFuncionarParaIdentificarAs3MaioresNotasPara2Alunos() {
		...
		notas.add(new Nota(1L, alunos.get(0), disciplina, 10.0));
		notas.add(new Nota(2L, alunos.get(1), disciplina, 7.5));
